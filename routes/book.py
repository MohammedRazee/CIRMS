...
def book(book_id):
    try:
        ...
        return render_template("book.html", title="book.name", book=found_book, review=find_review, score=score)
    
    except Exception as e:
        print(f"Connection in book failed: {e}")
        return render_template("book.html", title="Book", error="Unable to connect to the database.")
